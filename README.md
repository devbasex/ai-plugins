...
- **公開Skills**: Claude Code向け core 42個、Kiro向け core 41個、Codex向け core 40個、agy向け core 40個に分離。
- **元Skills（42個）**:
