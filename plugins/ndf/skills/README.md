...
| Kiro の初期 Skill 一覧の合計 | **25,000 文字**（10,000 トークン = コンテキストの 1%） | 公式ドキュメントに規定が無いため、コンテキスト長が同じ Claude Code の 1% を借りる。既定モデル auto のコンテキスト 1,000,000 から算出 |
...
| Kiro | auto | 1,000,000 | 1%（Claude Code から借りる） | 10,000 | 27,799 |
