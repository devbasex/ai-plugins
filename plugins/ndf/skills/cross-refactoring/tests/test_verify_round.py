...
def test_a_passing_test_closes_the_apply_round(patch_lib, gitfacts, paths, 
...
def test_a_failing_test_sends_the_apply_round_to_the_fix_loop(patch_lib, gitfacts, paths, 
    refactor, cmd_converge, tmp_path, env_tmp_dir, monkeypatch):
...
def test_a_failing_test_records_the_fix_base(patch_lib, gitfacts, paths, 
    refactor, cmd_converge, tmp_path, env_tmp_dir, monkeypatch):
...
def test_a_timeout_counts_as_a_failure(patch_lib, gitfacts, paths, refactor, cmd_converge, tmp_path, env_tmp_dir, monkeypatch):
...
def test_no_reviewer_is_launched(patch_lib, gitfacts, paths, refactor, cmd_converge, tmp_path, env_tmp_dir, monkeypatch):
...
def test_the_verification_uses_the_configured_timeout(patch_lib, gitfacts, paths, 
    refactor, cmd_converge, tmp_path, env_tmp_dir, monkeypatch):
...
def test_verifying_a_dropped_apply_round_is_refused(patch_lib, gitfacts, paths, 
    refactor, cmd_converge, tmp_path, env_tmp_dir, monkeypatch):
...
def test_the_phase_stays_on_apply_while_groups_remain(patch_lib, gitfacts, paths, 
    refactor, cmd_converge, tmp_path, env_tmp_dir, monkeypatch):
    groups = [
...
def test_the_phase_returns_to_propose_after_the_last_group(patch_lib, gitfacts, paths, 
    refactor, cmd_converge, tmp_path, env_tmp_dir, monkeypatch):
    state_path = _state(tmp_path)
    env_tmp_dir(state_path)
    _test_run(patch_lib, refactor, monkeypatch, code=0)
...
def test_a_passing_verification_names_the_items_and_the_plan(patch_lib, gitfacts, paths, 
    refactor, cmd_converge, tmp_path, env_tmp_dir, monkeypatch, capsys):
...
def test_a_failing_verification_still_names_the_plan(patch_lib, gitfacts, paths, 
    refactor, cmd_converge, tmp_path, env_tmp_dir, monkeypatch, capsys):
    url = "https://github.com/devbasex/ai-plugins/pull/130#issuecomment-7"
    state_path = _state(tmp_path, plan_mode="comment", plan_file="",
                        plan_comment={"id": 7, "url": url})
