...
def test_a_timeout_counts_as_a_failure(refactor, cmd_converge, tmp_path, env_tmp_dir, monkeypatch):
...
def test_no_reviewer_is_launched(refactor, cmd_converge, tmp_path, env_tmp_dir, monkeypatch):
