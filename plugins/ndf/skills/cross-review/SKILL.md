...
flowchart TD
    ...
    Round -.並列バックグラウンド.-> Seats["レビュー担当 2 席（start-round が返す）<br/>/ndf:pr-review &lt;PR&gt; &lt;席&gt; を席ごとに起動<br/>body 先頭: cross-review / round N / 席 / intent<br/>→ &lt;席&gt;-review-pr&lt;PR&gt;-result.json"]
