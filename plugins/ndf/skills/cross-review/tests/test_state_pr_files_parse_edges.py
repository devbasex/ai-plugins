...
def test_a_status_only_line_is_dropped(state_mod):
    ...
    assert review_lib.github._parse_pr_files_api_lines("modified") == []
...
def test_a_line_without_a_previous_column_yields_one_path(state_mod):
    ...
    assert review_lib.github._parse_pr_files_api_lines("modified\tsrc/app.py") == [
