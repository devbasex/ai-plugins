...
# => NDF統合開発エージェント（Kiro CLI用 / v9.1.0）
```
...
```text
# 動く: 実体パスを示して読ませる
~/.codex/plugins/cache/ai-plugins/ndf/9.1.0/skills/deploy/SKILL.md を読んで、その手順どおりに qa/staging へ deploy PR を作成してください。
...
# ~/.codex/plugins/cache/ai-plugins/ndf/9.1.0/skills/deploy/SKILL.md
```
...
# => ndf@ai-plugins  installed, enabled  9.1.0  <path>
```
