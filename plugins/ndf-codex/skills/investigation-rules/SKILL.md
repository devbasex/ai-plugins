...
description: "Never claim something is absent without showing the search behind it. Use when writing an investigation or bug report（調査レポートを書く・不具合レポート・カラムがない）."
---
