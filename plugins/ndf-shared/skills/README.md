...
| 全 Skill の frontmatter 合計 | 14,300 文字 | リポジトリ固有の運用値。開発方法論レイヤー 5 個の追加分（1 個あたり実測 約 210 文字）と帰属記録を見込み、約 6% の余裕を足した値。`scripts/check-skill-frontmatter.py` の `FRONTMATTER_TOTAL_MAX` |
