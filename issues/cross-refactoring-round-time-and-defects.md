...
3. 得点を**その提案へ投票できた人数**（4 − その提案の提案者数）で割って正規化し、
   `--min-score`（既定は 8 回目の実測で決める）未満を採用しない
...
- 提案者の自己申告と違い、他者の提案への評価になる。自分の提案には投票しないため、
  自分の案を通すための評価にならない
- 分母を一律に 4 とすると、提案者が複数いる項目ほど投票できる人数が減り、合意の広い項目が
  低く出る。投票できた人数で割れば、提案者の数によらず 0〜3 点の尺度が保たれる
...
- [ ] 投票者へ渡す一覧からその投票者の提案が外れ、得点は投票できた人数（4 − 提案者数）で正規化される
- [ ] 得点が閾値に満たない提案は採用されない
