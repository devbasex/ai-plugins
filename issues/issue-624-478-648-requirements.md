...
**この節は置き換えられた。** P4（AC1〜AC9）は [issue-732-624-706-requirements.md](issue-732-624-706-requirements.md) が持つ（親 #732 の設計。AC3 と AC6 は数える側へ改めた）。#583 の投稿の重なりは #730 の設計が持つ。以下は 2026-09-15 時点の記録として残す。
