...
**P5（#478 / #648、AC10〜AC30）は [issue-727-687-478-664-648-requirements.md](issue-727-687-478-664-648-requirements.md) が
置き換える**（親 #727 の設計、2026-09-19）。対応は置き換え先の「既存の受け入れ条件との対応」にある。この文書の P5 の
節は記録として残し、書き換えない。
