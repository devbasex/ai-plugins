...
| 2 | 実行の最後に自動送信 | 既定で収集。停止手段を提供 | 受け口・規約・運用 |
...
| E | 送信先を自前で運用する | 保留 | 第 2 段階の判断。保管と削除の責任が生じる |
...
- **満たす受け入れ条件:** 第 2 段階の 1〜6
- **進め方:** 第 1 段階の集計が研究に足りることを確認してから着手する。送信先は差し替え
  可能にしておく
- **備考:** この Task に入る前に、規約と受け口の運用を確定させる。受け口を自前で運用するか
  GitHub の Discussions を使うかもここで決める
