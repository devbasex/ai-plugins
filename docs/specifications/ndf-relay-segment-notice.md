...
| 5 | 利用者 | 何もせずに待つ |
| 6 | ラッパー | 印を拾い、静止を待って次の区間へ切り替える（ラッパーの本体は変えていない） |
...
| カットポイントの再起動は関門ではなく、ブロックの前に確認を挟まない | 状態は課題の本文と Pull Request に残り取り消せる。ラッパーの下で `AskUserQuestion` を出すと質問の印が切り替えを止め、人の入力が 1 回増える。ラッパーの外でも、確認の答えと貼り付けで入力が 2 度になる |
