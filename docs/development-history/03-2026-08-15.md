...
Skill の挙動そのものは
[`plugins/ndf-shared/skills/refactoring/`](../../plugins/ndf/skills/refactoring/SKILL.md)
...
- [refactoring Skill](../../plugins/ndf/skills/refactoring/SKILL.md)
- [Runtime Plugin 配布仕様](../specifications/runtime-plugin-distribution.md)
- [NDF Skill 棚卸台帳](../specifications/ndf-skill-inventory/01-ledger-and-criteria.md)
